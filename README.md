...
Коллекция **неофициальных приложений, каталогов и модов** для настольных игр.

Проекты созданы для **упрощения игрового процесса**, удобного просмотра игровых материалов и расширения возможностей настольных игр. Они представлены в виде:

- **Web-приложений**
- **Android-приложений**
- **каталогов карт**
- **модов для Tabletop Simulator**

Приложения и каталоги могут использовать PnP-изображения, свободно доступные в интернете.  
Некоторые изображения и звуки созданы или обработаны с помощью нейросетей.

> ⚠️ Все материалы **не являются официальными**, не связаны с издателями или правообладателями настольных игр и **не заменяют оригинальные игры**.

---

## 🎲 Компаньон-приложения

| Игра | Изображение | Wiki | Web | Android |
|------|-------------|------|-----|---------|
| Next Station | <img width="120" height="68" alt="Next Station" src="https://github.com/user-attachments/assets/08d86b13-cd5d-414e-b8b3-8d2dbcd3b240" /> | [Читать](https://github.com/LoneCubeGames/board-games-apps/wiki/Next-Station-Companion) | [Открыть](https://play.unity.com/en/games/1b07d943-f434-47c3-be59-f5f27bf93c34/next-station-companion) | [Скачать](https://github.com/LoneCubeGames/board-games-apps/releases) |
...
| The Quest For El Dorado | <img width="120" height="68" alt="The Quest For El Dorado" src="https://github.com/user-attachments/assets/a3bab794-c555-4bf3-91aa-33661a1cdcad" /> | [Читать](https://github.com/LoneCubeGames/board-games-apps/wiki/The-Quest-For-El-Dorado-Companion) | [Открыть](https://play.unity.com/en/games/8192c021-2a62-4927-ba4b-100f14c2186e/the-quest-for-el-dorado-companion) | — |

---

## 🃏 Каталоги карт

Веб-каталоги для удобного просмотра, поиска и изучения карт из настольных игр.

| Игра | Описание | Web |
|------|----------|-----|
| King of Tokyo | Каталог карт с описаниями и локализациями для удобного использования во время игры | [Открыть](https://kingoftokyo-card-catalog.pages.dev/) |

---

## 🧩 Моды в Tabletop Simulator

| Мод | Изображение | Описание | Steam Workshop |
|-----|-------------|----------|----------------|
...
Если вам нравятся эти проекты и вы хотите поддержать их дальнейшее развитие:

| Ссылка | QR |
|--------|----|
| [DonationAlerts](https://www.donationalerts.com/r/sergey_khanin) | <img src="https://files.donationalerts.com/uploads/qr/14525094/qr_06d368a6ab0f5d7507aaefe394ce37e0.png" width="200"/> |
