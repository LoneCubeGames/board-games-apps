...
Проекты созданы для **упрощения игрового процесса**, удобного просмотра игровых материалов и расширения возможностей настольных игр. Они доступны в виде:
...
Часть изображений и звуков создана или обработана с помощью нейросетей.

> ⚠️ Все материалы **не являются официальными** и **не заменяют оригинальные настольные игры**.
...
| The Quest For El Dorado | <img width="120" height="68" alt="Star Realms" src="https://github.com/user-attachments/assets/5db339cb-089c-44ad-8743-1400131586f1" /> | [Читать](https://github.com/LoneCubeGames/board-games-apps/wiki/The-Quest-For-El-Dorado-Companion) | — | — |

---

## 🃏 Каталоги карт

Веб-каталоги для удобного просмотра и поиска карт из настольных игр.

| Игра | Описание | WEB |
|------|----------|-----|
| King of Tokyo | Каталог карт с описаниями и локализациями для удобного просмотра во время игры | [Открыть](https://kingoftokyo-card-catalog.pages.dev/) |
