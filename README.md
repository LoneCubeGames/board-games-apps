...
Проекты предназначены для **упрощения игрового процесса**, автоматизации рутинных действий и повышения удобства игры в цифровом формате.

- Поддерживаются **WEB-версии** и **Android**
- Для каждого проекта доступна подробная **Wiki**
- Используются PnP-изображения из открытых источников  
- Часть изображений и звуков создана или обработана с применением нейросетей

> Все проекты **не являются официальными** и **не заменяют оригинальные настольные игры**.

---

## 🎲 Компаньон-приложения

Цифровые помощники для настольных игр: подсчёт очков, таймеры, автоматизация фаз и вспомогательные инструменты.
...
## 🧩 Моды для Tabletop Simulator

Игровые моды для **Tabletop Simulator** с автоматизацией сетапа, логики и вспомогательных механик.
...
> Моды предназначены для использования **только в Tabletop Simulator** и  
> **не являются официальными версиями настольных игр**.

---

## 🛠 Технологии

Все приложения разработаны на **Unity**.
